...
> Answer: Instant change in the page, No load times, 
- [ ] What does AJAX stand for?
> Answer: Asynchronous JavaScript And XML.
- [ ] What are `controlled components` in React?
> Answer: A react component that renders a form also controls what happens in that form on subsequent user input.
